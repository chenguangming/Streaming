...
#ifndef _ANDROID_FRAMED_SOURCE_HH
#define _ANDROID_FRAMED_SOURCE_HH

#include <jni.h>
#include "FramedSource.hh"

class AndroidFramedSource: public FramedSource {
public:
  static AndroidFramedSource* createNew(UsageEnvironment& env);
